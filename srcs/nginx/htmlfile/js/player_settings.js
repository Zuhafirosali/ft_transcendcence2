...
async function ppSaveChanges() {
    const firstName = document.getElementById('pp-firstName').value.trim();
    const lastName = document.getElementById('pp-lastName').value.trim();
    ...
    if (firstName.length > 35 || lastName.length > 35) {
        alert('First Name and Last Name must be at most 35 characters long.');
        return;
    }
    if (city.length > 35) {
        alert('City must be at most 35 characters long.');
        return;
    }
    if (bio.length > 75) {
        alert('Bio must be at most 75 characters long.');
        return;
    }
