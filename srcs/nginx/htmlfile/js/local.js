function local_pong(mode) {
    ...
    const neonOrange = rootStyles.getPropertyValue('--neon-orange').trim();
    const darkBg = rootStyles.getPropertyValue('--dark-bg').trim();
    ...
    class Local_Ball {
        ...
        draw(context) {
            context.fillStyle = neonOrange;
            context.strokeStyle = neonOrange;
            context.beginPath();
    ...
    class Local_Game {
        ...
        render(isPaused) {
            ...
            this.paddle1.draw(this.context, "#013577");
            if (this.mode == 'ai')
                this.paddle2.draw(this.context, "#A6A6A6");
            else
                this.paddle2.draw(this.context, "#e30102");
            this.drawGameFrame();
        ...
        drawGameFrame() {
            this.context.strokeStyle = neonOrange;
