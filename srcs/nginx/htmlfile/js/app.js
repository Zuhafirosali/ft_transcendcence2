        ...
        try {
            ...
            if(page.page != "../pages/home_page.html" || script === logoutPage){
                if(script){
                    ...
                    throw new Error('Script not found: ' + page.page + '. No scripts.');
                }
            }
...
// The DOM provides a structured way for programming languages like JavaScript to interact with and modify the content,
// structure, and styles of a web page dynamically. It serves as a bridge between the raw HTML code and JavaScript,
// allowing you to update and manipulate the page without reloading it.